          ...
          <nav className="flex items-center justify-between">
            <Link href="/" className="flex items-center">
              <div className="relative h-12 w-12 mr-3">
                <Image
                  src="/images/era-trio-logo.png"
                  alt="The Era Trio Logo"
                  fill
                  className="object-contain"
                />
              </div>
              <span className="text-2xl font-serif text-gold-400 tracking-wide">
                The Era Trio
              </span>
            </Link>
        ...
        <div className="container mx-auto px-4 h-full flex items-center relative z-10">
          <div className="max-w-3xl">
            <h1 className="font-serif text-5xl md:text-7xl text-cream-100 leading-tight mb-4">
              Chicago's Finest{" "}
              <span className="text-gold-400">Funk & Jazz</span> Experience
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl">
              A vibrant blend of funk, blues, soul, and jazz that ignites crowds
              and sets the perfect vibe for any venue.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="#music">
                <Button
                  variant="outline"
                  className="border-cream-100/20 text-cream-100 hover:bg-cream-100/10 w-full"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              <h2 className="font-serif text-4xl text-gold-400 mb-6">
                About The Era Trio
              </h2>
              <p className="text-cream-100/90 mb-6 leading-relaxed">
                ...
                styles and fresh Chicago spirit.
              </p>
              <p className="text-cream-100/90 mb-8 leading-relaxed">
                Equally at home igniting lively bar crowds or setting a smooth,
                laid-back vibe for speakeasies, our sound transcends generations
                while staying true to the rich musical heritage of Chicago.
              </p>
              <Button
                variant="outline"
      ...
      <section id="music" className="py-24 bg-navy-950 relative scroll-mt-16">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl text-gold-400 mb-4">
              Our Music
            </h2>
            <p className="text-cream-100/70 max-w-2xl mx-auto">
              Experience our unique blend of funk, blues, soul, and jazz that
              defines The Era Trio sound.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="relative rounded-lg overflow-hidden shadow-xl">
              ...
              <div className="relative aspect-video">
                <iframe
                  src="https://www.youtube.com/embed/pp2ExlDgl28?si=LKcXq0H7eQlBc0M3"
            ...
            <div className="relative rounded-lg overflow-hidden shadow-xl">
              ...
              <div className="relative aspect-video">
                <iframe
                  src="https://www.youtube.com/embed/Tfi9_aw3sM0?si=HtIJdcaMLHLKV0-k"
                  title="YouTube video player"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerPolicy="strict-origin-when-cross-origin"
                  allowFullScreen
      ...
      <section id="shows" className="py-24 bg-navy-900 scroll-mt-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-cream-100/70 max-w-2xl mx-auto">
              Catch The Era Trio live at these upcoming venues around Chicago
              and beyond.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="md:w-1/3">
                  <h3 className="font-serif text-xl text-cream-100 text-center md:text-left">
                    {show.venue}
                  </h3>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-navy-900/80 rounded-xl p-8 md:p-12 border border-cream-100/10">
            <div className="text-center mb-12">
              ...
              <p className="text-cream-100/70 max-w-2xl mx-auto">
                Book The Era Trio for your venue, event, or just drop us a line
                to say hello.
              </p>
              <p className="text-gold-400/80 mt-2">
                Messages will be sent to: jafritzel@gmail.com
              </p>
            </div>

            {isSubmitted ? (
              <div className="bg-green-900/30 border border-green-500/30 rounded-lg p-6 text-center">
                <h3 className="text-xl font-serif text-green-400 mb-2">
                  Message Sent!
                </h3>
                ...
                <Button
                  onClick={resetForm}
                  className="mt-4 bg-gold-500 hover:bg-gold-600 text-navy-950"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label
                      htmlFor="email"
                      className="block text-cream-100 mb-2"
                    >
                      Email
                    </label>
                    <input
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0 flex items-center">
              ...
              <div>
                <Link
                  href="/"
                  className="text-2xl font-serif text-gold-400 tracking-wide"
                >
                  The Era Trio
                </Link>
                <p className="text-cream-100/60 mt-1">
                  Chicago's finest funk & jazz experience
                </p>
              </div>
            </div>
          ...
          <div className="border-t border-cream-100/10 mt-8 pt-8 text-center">
            <p className="text-cream-100/60">
              © {new Date().getFullYear()} The Era Trio. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
